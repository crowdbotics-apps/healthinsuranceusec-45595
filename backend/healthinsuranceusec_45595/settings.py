"""
Django settings for healthinsuranceusec_45595 project.
...
ROOT_URLCONF = 'healthinsuranceusec_45595.urls'
...
WSGI_APPLICATION = 'healthinsuranceusec_45595.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "healthinsuranceusec_45595 API",
    "DESCRIPTION": "API documentation for healthinsuranceusec_45595 App",
    "VERSION": "v1",
}
